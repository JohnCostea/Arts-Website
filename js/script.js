    ...
    fetch('get_cart.php')
        ...
        .then(data => {
            if (data.success) {
                ...
                renderCart();
                // Also update badge directly to ensure it's updated
                updateCartBadge();
            }
        })
...
function addToCart(productId, productName, price, imageUrl) {
    ...
    .then(data => {
        if (data.success) {
            ...
            // Reload cart from session to update display and badge
            loadCartFromSession();
        } else {
 ...
 * Shows/hides badge and animates on change
 */
function updateCartBadge() {
    ...
    console.log('Updating cart badge, total items:', totalItems); // Debug log
