...
<body>
    ...
    <header style="background-image: url('img/Background_Brushes.jpg'); background-position: bottom; background-size: cover;">
    ...
    <!-- Checkout Modal -->
    <div id="checkoutModal" class="modal" style="display: none; position: fixed; z-index: 1; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0,0,0,0.4);">
